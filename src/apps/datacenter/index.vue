<template>
  <div class="datacenter">
    <Head :title="title" :type="datacenter" :headclass="headclass" class="head"></Head>
    <!-- <div class="top">
      <div class="top_img">
    ...
    <div class="my-content">
      <div class="my-content-area-face credit">
        ...
        <div class="contentc blue">免认证</div>
      </div>
      <div class="my-content-area-face face" @click="humanface">
        ...
        <div :class="{contentc:true,blue:truncate.borrowCart=='1',grey:truncate.borrowCart=='0'}">
      ...
      <div class="my-content-area-face personage" @click="personage">
        ...
        <div :class="{contentc:true,blue:truncate.borrowMsg=='1',grey:truncate.borrowMsg=='0'}">
      ...
      <div class="my-content-area-face bankcard" @click="bindbankcard">
        ...
        <div :class="{contentc:true,blue:truncate.bindCard=='1',grey:truncate.bindCard=='0'}">
      ...
      <div class="my-content-area-face phone" @click="operator">
        ...
        <div :class="{contentc:true,blue:truncate.operators=='1',grey:truncate.operators=='0'}">
